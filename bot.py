...
if not all([BOT_TOKEN, BINANCE_KEY, BINANCE_SECRET]):
    raise ValueError("Variables d'environnement manquantes ! Ajoute BOT_TOKEN, BINANCE_KEY, BINANCE_SECRET sur Render.")
...
# Mini serveur Flask → répond sur / pour que Render détecte le port + évite spin-down
...
if __name__ == "__main__":
    ...
    # Lance Flask en thread (daemon pour pas bloquer)
    threading.Thread(target=run_flask, daemon=True).start()

    # Lance le bot polling
